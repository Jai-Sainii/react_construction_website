...
const Home = () => {
  ...
  }, [services]); // Trigger GSAP when services are loaded
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div ref={heroRef} className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8">
          ...
          >
            Building the <span className="text-orange-500 block">Future</span>
          </motion.h1>
          <motion.p
          ...
          >
            From concept to completion, we deliver exceptional construction solutions that stand the test of time.
          </motion.p>
          <motion.div
              ...
              services.map((service) => (
                ...
                >
                  <div className="p-6">
                    ...
                    <div className="text-orange-500 font-semibold text-lg mb-4">{service.price}</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.length > 0 ? (
              ...
              <p className="text-center text-gray-500 col-span-3">Loading projects...</p>
            )}
          </div>
