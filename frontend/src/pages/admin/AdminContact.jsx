...
const AdminContact = () => {
  ...
  const selectedContact = contacts.find(c => c._id === selectedMessage);
              ...
              filteredContacts.map(contact => (
                <motion.div
                  ...
                  className={`p-4 border-b border-gray-100 cursor-pointer hover:bg-gray-50 transition-colors ${
                    selectedMessage === contact._id ? 'bg-orange-50 border-orange-200' : ''
                  }`}
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex space-x-2">
                      <button
                        onClick={(e) => { e.stopPropagation(); handleViewMessage(contact._id); }}
